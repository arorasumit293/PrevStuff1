	...
	<br />
		...
		<div id="content">
			<legend><h3>Privacy Policy</h3></legend>
				<p>The Shopbucket Incorporated respect the privacy of the visitors
					to the Shopbucket.com website and the local websites connected with it, and take great care to protect your 
			...
			<hr>
				<h4>Protection of visitors information</h4>
					<p>In order to protect the information you provide to us by visiting our website we have implemented various
						...
						risk that third parties may intercept and use that information. While Shopbucket strives to protect its user's 
			...
			<hr>
				<h4>Online policy</h4>
					<p>The Privacy Policy does not extend to anything that is inherent in the operation of the internet, and 
						therefore beyond Shopbucket's control, and is not to be applied in any manner contrary to applicable law or 
...
<div>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Shopbucket Inc</p>
		</div>

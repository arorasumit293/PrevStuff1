...
$paypal_id='sb-qhnor14478216@business.example.com'; // Business email ID
...
<div class="">
    ...
    <input type="hidden" name="item_name" value="ShopBucket Products">

	...
	<legend>About Us</legend>
		<div id="content">
			<legend><h3>Mission</h3></legend>
					<h4 style="text-indent:60px;">To provide high quality products that suit the user's style and to be one of the leading ecommerce website in the country.</h4>
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">Shopbucket, the company that inspire, motivate, and give determination to People.</h4>
			<br />

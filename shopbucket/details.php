		...
		?>
				<div>
					<center>
						...
						<h3 class="text-uppercase">USD <?php echo $row['product_price']?></h3>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<h4>Total: USD <?php echo $row['product_price']; ?> </h4>
						<br />
	...
	<div id="footer">
		<div class="foot">
			...
			<div id="develop">
				<h4>Developed By:</h4>
					<ul>
						<a href="#"><li>21BCS8815</li><a>
						<a href="#"><li>20BCS6894</li><a>
						<a href="#"><li>20BCS6624</li><a>
					</ul>
			</div>
	</div>
</body>
